...
mongoose.set('strictQuery', false); //mongodb+srv://ramangroverind:Akashraman@cluster0.xykllbe.mongodb.net/knocial_india?retryWrites=true&w=majority
...
mongoose.connect('mongodb+srv://akashdagur:mMg0AbF7x3GHpMM6@cluster0.en8s94w.mongodb.net/knocial_india?retryWrites=true&w=majority', function (err) {
  if (!err) {
    // console.log(db);
